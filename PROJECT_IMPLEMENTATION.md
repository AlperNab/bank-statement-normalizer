# Bank Statement Normalizer — Standalone Real GUI Implementation
...
Default URL: `http://127.0.0.1:9103`

## What is inside this project folder

- `app/` — FastAPI backend for this project.
- `static/` — elegant browser GUI.
- `plugins/bank-statement-normalizer.json` — this project’s own feature/customization/input schema.
...
- `personal_business_mode` — personal/business mode (select)
- `privacy_redaction` — privacy redaction (text)
...
- `statement_files` — Statement files (text) required
